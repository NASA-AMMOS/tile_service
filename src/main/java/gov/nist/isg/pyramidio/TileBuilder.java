 ...
 */
//class TileBuilder {
public class TileBuilder { //vona

    public interface Debug { void log(String msg); } //vona
    public static Debug debug; //vona
    ...
    private class TileBuilderTask extends RecursiveTask<BufferedImage> {
        ...
        private ImageReaderCache imageReaderCache; //vona 10/21/21 https://github.com/usnistgov/pyramidio/issues/15
        ...
        private TileBuilderTask(int level, int tileRow, int tileColumn,
            ...
            if (useCache && level == cacheLevel) {
                ...
                if (tileRegion != null) {
                    try {
                        if (debug != null) { //vona
                            debug.log("loading chunk " + tileRegion);
                        }
                        imageReaderCache = new ImageReaderCache(
                                imageReader, tileRegion);
                        if (debug != null) { //vona
                            debug.log("loaded chunk " + tileRegion);
                        }
                    } catch (Exception e) {
        ...
        protected BufferedImage compute() {
            ...
            imageReaderCache = null; //vona 10/21/21 https://github.com/usnistgov/pyramidio/issues/15
